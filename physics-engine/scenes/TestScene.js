...
TestScene.prototype.setup = function() {
	...
	// smallEntity.applyImpulse(createVector(0, 2000));
	smallerEntity.applyImpulse(createVector(0, 170));
	this.collection.addEntities([bigEntity, smallEntity, smallerEntity]);
}
